...
−13h   UTC−04                yesterday | MON | 21 SEP    (仅说明为强调色)
...
- 强调色**按天色取值**(`--tz-accent`,与 `--tz-c0/-c1/-c2` 定义在一起、一同过渡):没有任何单一蓝色
  能同时适配四种天色 —— 浅蓝在白天与黎明卡片上只有 1.1–1.3:1,深蓝在夜晚卡片上只有 1.5:1。因此
  白天 / 黎明 / 黄昏用深蓝 `#12307d`(7.6 / 7.7 / 3.1),夜晚用浅蓝 `#9dc2ff`(7.9)。
